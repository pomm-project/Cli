...
class GenerateRelationStructure extends ModelSessionAtoum
{
    ...
    public function testExecute()
    {
        ...
        $this
            ...
            ->isEqualTo(file_get_contents('sources/tests/Fixture/BetaStructure.php'))
            ;
        $tester->execute(array_merge($command_args, ['--dir-pattern' => '{Session}']), $options);
        $this
            ->string($tester->getDisplay())
            ->isEqualTo(" ✓  Creating file 'tmp/Model/PommTest/AutoStructure/Beta.php'.".PHP_EOL)
            ->string(file_get_contents('tmp/Model/PommTest/AutoStructure/Beta.php'))
            ->isEqualTo(file_get_contents('sources/tests/Fixture/BetaStructurePatternPath.php'))
        ;
